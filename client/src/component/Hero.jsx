...
function Hero() {
    return(
        <>
            <div className="w-full h-screen bg-custom-cream top-5 items-center justify-center">
                ...
                <div className=''>
                    <div className="bg-custom-cream text-black flex flex-row gap-4 md:gap-8 py-8 justify-center items-center -mt-14 z-[15]">
